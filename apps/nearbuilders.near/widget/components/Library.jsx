...
const {
  ...
  Avatar,
  Checkbox,
} = VM.require("${config/account}/widget/components") || {
  Button: () => <></>,
  Pagination: () => <></>,
  ProgressState: () => <></>,
  Step: () => <></>,
...
const components = [
  {
    ...
    widgetSrc: "${config/account}/widget/components",
    description:
  ...
  },
  {
    ...
    embedCode: `
  const { Pagination } = VM.require("${config/account}/widget/components.
  ...
  },
  {
    ...
    embedCode: `
  const { ProgressState } = VM.require("${config/account}/widget/components");
  ...
  },
  {
    ...
    embedCode: `
  const { Step } = VM.require("${config/account}/widget/components");
  ...
  },
  {
    ...
    embedCode: `
  const { InputField } = VM.require("${config/account}/widget/components");
  ...
  },
  {
    ...
    embedCode: `
  const { Checkbox } = VM.require("${config/account}/widget/components");
  ...
  },
  {
    ...
    embedCode: `
  const { TextBox } = VM.require("${config/account}/widget/components");
  ...
  },
  {
    ...
    embedCode: `
  const { TextEditor } = VM.require("${config/account}/widget/components");
  ...
  },
  {
    ...
    embedCode: `
  const { UploadField } = VM.require("${config/account}/widget/components");
  ...
  },
  {
    ...
    embedCode: `
  const { User } = VM.require("${config/account}/widget/components");
