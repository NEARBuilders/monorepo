...
return (
  <div className="mt-4 ndc-card p-4">
    <div className="d-flex flex-column gap-4">
      ...
      <div>
        <h3 className="h6 fw-bold mb-0">Proposals</h3>
        <p className="text-black-50 fw-light small">
          Choose what proposal rights you give to specific roles. This can be
          updated in settings later.
        </p>
        {renderTable(rolesArray, proposalKinds, "AddProposal")}
      </div>

      <div>
        <h3 className="h6 fw-bold mb-0">Voting</h3>
        <p className="text-black-50 fw-light small">
          Choose what voting permissions you give to specific roles. This can be
          updated in settings later.
        </p>
