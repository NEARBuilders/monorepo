...
const thingData =
  props.thingData ?? Social.get(`*/thing/${thingId}/metadata/**`, "final");

if (!thingData) {
  return "details not found";
}

const thingKey = Object.keys(thingData)[0];

const tags = Object.keys(thingData[thingKey].thing[thingId].metadata.tags);
const thingUrl = `/hack.near/widget/Group?thingId=${thingId}`;
...
return (
  <Card>
    <CardLeft>
      <Widget
        src="hack.near/widget/thing.inline"
        props={{ thingId, namespace: "thing", creatorId: accountId }}
      />
    </CardLeft>
    <Bell>
    ...
    {canJoin && context.accountId && (
      <>
        {thingKey === context.accountId && (
          <a
            className="btn btn-outline-dark"
            href={`/hack.near/widget/thing.edit?thingId=${thingId}`}
          >
            edit
          </a>
        )}
