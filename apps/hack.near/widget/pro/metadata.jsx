...
State.init({
  ...
  languages: initialMetadata.languages,
...
const metadata = {
  ...
  backgroundImage:
    ...
    Object.keys(state.backgroundImage).length > 0
      ? state.backgroundImage
      : undefined,
  location: options.location ? state.metadata.location : undefined,
  languages: options.languages ? state.metadata.languages : undefined,
...
const onLanguagesChange = debounce((e) => {
  State.update({
    metadata: {
      ...state.metadata,
...
return (
  <>
    ...
    {options.location && (
      <div className="mb-2">
        {options.location.label ?? "Location"}
        <input
          type="text"
          defaultValue={state.metadata.location}
    ...
    {options.languages && (
      <div className="mb-2">
        {options.languages.label ?? "Language(s)"}
        <input
          type="text"
          defaultValue={state.metadata.languages}
